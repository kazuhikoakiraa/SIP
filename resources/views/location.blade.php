                ...
                <tbody>
                    ...
                    <tr class="bg-white hover:bg-[#FFF4E0] transition duration-300 border-b border-gray-300">
                        ...
                        <td class="px-2 py-4 text-center">
                            <button type="button" class="focus:outline-none text-white bg-green-600 hover:bg-green-700 font-medium rounded-full text-sm px-6 py-2.5 mb-2 transition duration-300 shadow-md" onclick="openModal('edit-modal-{{ $item->id }}')">Edit</button>
                            <button type="button" class="focus:outline-none text-white bg-red-600 hover:bg-red-700 font-medium rounded-full text-sm px-6 py-2.5 transition duration-300 shadow-md" onclick="openModal('delete-modal-{{ $item->id }}')">Delete</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
