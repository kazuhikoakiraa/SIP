...
<body">
    ...
    @endif
            ...
            <tbody>
                ...
                <tr class="bg-white border-1 border-black">
                    ...
                    <td class="px-2 py-2 text-center">
                        <button type="button" class="focus:outline-none text-black bg-green-600 font-medium rounded-lg text-sm px-8 py-2.5 mb-2" onclick="openModal('edit-pump-{{$item->id}}')">Edit</button>
                        <button type="button" class="focus:outline-none text-black bg-red-600 font-medium rounded-lg text-sm px-6 py-2.5" onclick="openModal('delete-pump-{{$item->id}}')">Delete</button>
                    </td>
                </tr>
        ...
        <div id="add-pump" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 overflow-y-auto">
            <div class="bg-white p-4 rounded-lg w-full h-1/2 sm:w-full md:w-1/2 lg:w-1/2 max-h-full overflow-y-auto">
                ...
                <form action="{{route('pump.store')}}" method="POST" enctype="multipart/form-data" id="add-form">
                    @csrf
    ...
    <div id="edit-pump-{{$item->id}}" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 overflow-y-auto">
        <div class="bg-white p-4 rounded-lg w-full h-1/2 sm:w-full md:w-1/2 lg:w-1/2 max-h-full overflow-y-auto">
            ...
            <div class="flex flex-col md:flex-row gap-4 mb-2">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex justify-end">
                        <button type="button" class="bg-red-500 text-white px-4 py-2 rounded-md mr-2" onclick="closeModal('edit-pump-{{$item->id}}')">Batal</button>
        ...
        <!-- Modal Hapus Data -->
        @foreach ($pump as $item)
        <div id="delete-pump-{{$item->id}}" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white p-4 rounded-lg w-1/3">
                ...
                <div class="flex justify-end">
                    <button type="button" class="bg-red-500 text-white px-4 py-2 rounded-md mr-2" onclick="closeModal('delete-pump-{{$item->id}}')">Batal</button>
